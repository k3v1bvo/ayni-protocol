...
import {
  ...
  Store, Star, LogOut, Bell, Search, Menu, X, ChevronRight, Sparkles, Wallet, Settings, Gift, Users, FileCode, Crown
} from 'lucide-react';
...
const NAV_ITEMS = {
  common: [
    ...
    { href: '/dashboard/premium', label: 'Membresía Premium', icon: Crown },
  ],
  client: [
